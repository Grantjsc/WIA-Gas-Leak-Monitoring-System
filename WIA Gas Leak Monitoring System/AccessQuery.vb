...
Module AccessQuery_Module
    ...
    Public Acc_connString As String = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\LF Database\WIA Gas Leak Monitoring.accdb;Persist Security Info=True;Jet OLEDB:Database Password=lfwiagasleak"
    Public Acc_Dbconnection As New OleDbConnection(Acc_connString)
    'Public Biometric_Name As String

    Sub Acc_ConOpen()
        If Acc_Dbconnection.State = ConnectionState.Closed Then
            Acc_Dbconnection.Open()
        End If
    End Sub

    Sub Acc_ConClose()
        If Acc_Dbconnection.State = ConnectionState.Open Then
            Acc_Dbconnection.Close()
        End If
    End Sub
    ...
    Sub Get_Details()
        Try
            ...
            cmd.Connection = Acc_Dbconnection
            ...
            If Data.Rows.Count > 0 Then
                ...
                Receivers_Email = Data.Rows(0).Item("Receiver_Email").ToString
    ...
    Sub Get_Recipients_NumberEmail()
        Try
            Dim MyData As String
            Dim cmd As New OleDbCommand
            Dim Data As New DataTable
            ...
            If Data.Rows.Count > 0 Then
                ...
                RecipientDelay_Form.txtNumber.Text = Data.Rows(0).Item("Receiver_Number").ToString
                'Mess = Data.Rows(0).Item("Message").ToString
                RecipientDelay_Form.txtEmail.Text = Data.Rows(0).Item("Receiver_Email").ToString
    ...
    Sub Update_Recipients_NumberEmail()
        Try
            Dim db_ID As String = "1"
            Dim num As String = RecipientDelay_Form.txtNumber.Text
            Dim email As String = RecipientDelay_Form.txtEmail.Text

            Dim query As String = "UPDATE Details_tb SET Receiver_Number = @number, Receiver_Email = @emails
                                   WHERE ID = @id"

            Using command As New OleDbCommand(query, Acc_Dbconnection)
